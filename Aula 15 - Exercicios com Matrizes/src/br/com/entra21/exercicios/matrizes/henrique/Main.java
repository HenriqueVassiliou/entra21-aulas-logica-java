package br.com.entra21.exercicios.matrizes.henrique;
...
public class Main {
	...
	public static String escreverMenu() {
		...
		menu += "\t2 - Inicializar Matriz 2 Niveis";
		menu += "\t3 - Criar Matriz com 5 vetores e 3 itens de capacidade";
		menu += "\t4 - Criar matrizes de vetores conforme a vontade do usuario";
	...
	public static void inicializeMatriz() {
...
//  Verificar os detalhes na perspectiva DEBUG
		...
		double matrizDouble[][] = { // quem define o tamanho de cada vetor é a incialização, que pode ser irregular.
				{ 100, 400, 500 }, { 100, 200, 400 }, { 1000, 4000, 5000, 6000 }, };
	}
