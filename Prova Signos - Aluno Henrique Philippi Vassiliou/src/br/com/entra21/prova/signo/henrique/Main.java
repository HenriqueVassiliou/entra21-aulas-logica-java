		...
		// de 20/2 ate 20/3    Peixes
		 ...
		 Scanner ler = new Scanner(System.in);
	      ...
	      if (((mes == 3) && ((dia >=21) && (dia <= 31))) ||
	         (mes == 4 && (dia >= 1) && (dia <= 20)))
	    	  System.out.println(nome+" você é de Aries");
	      if (((mes == 4) && ((dia >=21) && (dia <= 30))) ||
	 	         (mes == 5 && (dia >= 1) && (dia <= 20)))
	 	    	  System.out.println(nome+" você é de Touro");
	      if (((mes == 5) && ((dia >=21) && (dia <= 31))) ||
		 	         (mes == 6 && (dia >= 1) && (dia <= 20)))
		 	    	  System.out.println(nome+" você é de Gemeos");
	      if (((mes == 6) && ((dia >=22) && (dia <= 30))) ||
		 	         (mes == 7 && (dia >= 1) && (dia <= 21)))
		 	    	  System.out.println(nome+" você é de Cancer");
	      if (((mes == 7) && ((dia >=21) && (dia <= 31))) ||
		 	         (mes == 8 && (dia >= 1) && (dia <= 22)))
		 	    	  System.out.println(nome+" você é de Leao");
	      if (((mes == 8) && ((dia >=23) && (dia <= 31))) ||
		 	         (mes == 9 && (dia >= 1) && (dia <= 22)))
		 	    	  System.out.println(nome+" você é de Virgem");
	      if (((mes == 9) && ((dia >=23) && (dia <= 30))) ||
		 	         (mes == 10 && (dia >= 1) && (dia <= 22)))
		 	    	  System.out.println(nome+" você é de Libra");
	      if (((mes == 10) && ((dia >=23) && (dia <= 31))) ||
		 	         (mes == 11 && (dia >= 1) && (dia <= 21)))
		 	    	  System.out.println(nome+" você é de Escorpião");
	      if (((mes == 11) && ((dia >=22) && (dia <= 30))) ||
		 	         (mes == 12 && (dia >= 1) && (dia <= 21 )))
		 	    	  System.out.println(nome+" você é de Sagitario ");
	      if (((mes == 12) && ((dia >=22) && (dia <= 31))) ||
		 	         (mes == 1 && (dia >= 1) && (dia <= 20)))
		 	    	  System.out.println(nome+" você é de Capricornio");
	      if (((mes == 1) && ((dia >=21) && (dia <= 31))) ||
		 	         (mes == 2 && (dia >= 1) && (dia <= 19)))
		 	    	  System.out.println(nome+" você é de Aquario");
	      if (((mes == 2) && ((dia >=20) && (dia <= 29))) ||
		 	         (mes == 3 && (dia >= 1) && (dia <= 20)))
		 	    	  System.out.println(nome+" você é de Peixe");
	
	      else {
              System.out.println("Erro: Insira um dia ou mes valido!");
              main(null);
	      }
